...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MySocket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 66, 1),
QT_MOC_LITERAL(8, 68, 10)
    },
    "MySocket\0changed\0\0connectChange\0"
    "connected\0disconnected\0setStarted\0s\0"
    "writeBiais"
};
...
void MySocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 1: _t->connectChange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->connected(); break;
        case 3: _t->disconnected(); break;
        case 4: _t->setStarted((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->writeBiais(); break;
        default: ;
        }
        ...
        {
            typedef void (MySocket::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySocket::changed)) {
                *result = 0;
            }
        }
        {
            typedef void (MySocket::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySocket::connectChange)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject MySocket::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MySocket.data,
      qt_meta_data_MySocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySocket.stringdata))
...
// SIGNAL 0
void MySocket::changed(QPointF _t1)
{
...
// SIGNAL 1
void MySocket::connectChange(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
