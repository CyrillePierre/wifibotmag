...
QT_MOC_LITERAL(6, 56, 11)
    ...
    "MySocket\0changed\0\0connect_change\0"
    "connected\0disconnected\0set_started"
};
...
void MySocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< QVector2D(*)>(_a[1]))); break;
        case 1: _t->connect_change((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->connected(); break;
        case 3: _t->disconnected(); break;
        case 4: _t->set_started(); break;
        default: ;
        }
        ...
        {
            typedef void (MySocket::*_t)(QVector2D );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySocket::connect_change)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MySocket::changed(QVector2D _t1)
{
...
// SIGNAL 1
void MySocket::connect_change(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
